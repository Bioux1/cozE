...
class Invite(commands.Cog):
    ...
    async def invite(self, ctx):
        ...
        await ctx.send(f"{ctx.author.mention}, if you want to add cozE bot to your own server please click the button below and fill out the form.", view = request_button())
